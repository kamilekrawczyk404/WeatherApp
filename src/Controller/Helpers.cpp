...
nlohmann::json Helpers::getDate(time_t unixSeconds, int shift, int currentGMTOffset) {
    ...
    const std::vector<std::string> 
        ...
        weekdaysInPolish({"Niedz.", "Pon.", "Wt.", "Sr.", "Czw.", "Pt.", "Sob."}),
...
std::string Helpers::getPath(std::string path) {
//    std::__fs::filesystem::path executablePath = getExecutablePath();
//    std::__fs::filesystem::path executableDir = executablePath.parent_path();
//    std::__fs::filesystem::path fullPath = executableDir / path;
