...
void Layout::foreignLanguages(sf::RenderWindow &window) {
    ...
    for (int i = 0; i < countries.size(); i++) {
        ...
        Image flag("images/countriesFlags/" + countries.at(i) + ".png");
...
void Layout::leftSide(sf::RenderWindow &window) {
    ...
    if (!currentDay) {
        Image sunrise("images/weatherIcons/sunrise.png");
        ...
        Image sunset("images/weatherIcons/sunset.png");
    ...
    Image currentIcon("images/weatherIcons/" + iconName);
...
void Layout::specificInformation(int& index, sf::RenderWindow &window, std::string key, json& data, sf::Vector2f position) {
    ...
    if (key == "Wind") {
        Image windDirection("images/weatherIcons/" + key + "_direction.png");
    ...
    Image icon(  "images/weatherIcons/" + key + ".png");
...
//    
    ...
    Image mainIcon("images/weatherIcons/" + mainIconName);
    ...
    Image secondaryIcon("images/weatherIcons/" + secondaryIconName);
